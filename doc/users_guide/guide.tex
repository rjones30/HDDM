...
work directory and use it as a template in building a python module to read the data
...
If you have access to a HDDM file that was already written, copy it into your
work directory and use it as a template in building a C++ library to read and
