...
would translate to istr.compression = flags.
...
the input file fil is a \texttt{hddm\_}XXX\texttt{.istream}.
\item list semantics for {\em Element}\texttt{List} containers\\
See the C++ API section for details on {\em Element}\texttt{List}
containers. These support standard python list semantics through the
