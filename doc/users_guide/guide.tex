...
would be if you used the example input file \texttt{models/exam1x.hddm}. Later on
when you have written some data to the HDDM file, come back and try it again. The
full set of methods and attributes supported by the python module is displayed by
the command \texttt{pydoc hddm\_x}.
