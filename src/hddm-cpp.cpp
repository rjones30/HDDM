...
int main(int argC, char* argV[])
{
   ...
   "   size_t getTag(const std::string &src, int p_src, std::string &tag, int &level);\n"
   "   size_t getEndTag(const std::string &src, int p_src, const std::string &tag);\n"
   ...
   "   {}\n"
   "\n"
   "   HDDM_ElementList& operator=(const HDDM_ElementList<T> &src)\n"
   "   {\n"
   "      m_host_plist = src.m_host_plist;\n"
   "      m_first_iter = src.m_first_iter;\n"
   "      m_last_iter = src.m_last_iter;\n"
   ...
   "}\n"
   "\n"
   "size_t istream::getTag(const std::string &src, int start,\n"
   ...
   "}\n"
   "\n"
   "size_t istream::getEndTag(const std::string &src, int start,\n"
